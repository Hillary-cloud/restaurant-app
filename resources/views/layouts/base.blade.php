            ...
            @auth
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                        <a class="dropdown-item" href="{{route('admin.menus')}}"><i class="fa fa-tachometer"></i> Menu</a>
                        <a class="dropdown-item" href="{{route('admin.tables')}}"><i class="fa fa-image"></i> Table</a>
                        <a class="dropdown-item" href="{{route('admin.orders')}}"> <i class="fa fa-book"></i> Orders</a><hr>
                  ...
                  <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                        ...
                        <a class="dropdown-item" href="{{route('my-orders')}}"><i class="fa fa-book"></i> Order History</a>
                        <i class="fa fa-sign-out"></i> <a href="{{ route('logout') }}"
                                                    onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                                                    {{ __('Log Out') }}
                                                </a>
